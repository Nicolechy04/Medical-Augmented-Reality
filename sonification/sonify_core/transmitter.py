...
class OSC_Transmitt_Process:
    ...
    def oscTransmittProc_RecordStart(self, recording_path=None):
        oscName_t = '/record/start'
        if recording_path is None:
            recording_path = Path.cwd() / "inference" / "recording.wav"
        else:
            recording_path = Path(recording_path)
        recording_path.parent.mkdir(parents=True, exist_ok=True)
        self.client.send_message(oscName_t, [recording_path.as_posix()])
        # print('record start sent!')
