"""Named physical-parameter ranges and legacy constants used by sonification."""
...
# Each class entry stores ranges in the order: mass, stiffness, damping.
...
# Mapping names passed on the command line resolve through this table.
RANGE_PARAMS_ALL = {
